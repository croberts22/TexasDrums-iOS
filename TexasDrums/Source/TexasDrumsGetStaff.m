...
@implementation TexasDrumsGetStaff
...
- (NSURL *)requestURL {
    ...
    NSString *request_URL = [NSString stringWithFormat:@"%@staff.php?apikey=%@", server, [TexasDrumsRequest TexasDrumsAPIKey]];
