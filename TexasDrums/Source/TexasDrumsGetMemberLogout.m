...
@implementation TexasDrumsGetMemberLogout
...
- (NSURL *)requestURL {
    ...
    NSString *request_URL = [NSString stringWithFormat:@"%@logout.php?apikey=%@&username=%@&password=%@&device=mobile", server, [TexasDrumsRequest TexasDrumsAPIKey], _username, _password]; 
